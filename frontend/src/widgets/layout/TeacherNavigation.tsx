...
const navItems = [
  { href: '/teacher', icon: LayoutDashboard, label: 'Gap Dashboard' },
  { href: '/teacher/students', icon: Users, label: 'All Students' },
  { href: '/teacher/interventions', icon: Zap, label: 'Interventions' },
  { href: '/teacher/digest', icon: Mail, label: 'Weekly Digest' },
  ...
  return (
    <aside className="sidebar-panel fixed left-0 top-0 h-screen bg-sidebar border-r border-sidebar-border flex flex-col">
      <div className="sidebar-header border-b border-sidebar-border">
        <Link href="/teacher" className="flex items-center gap-[var(--sidebar-gap)]">
          <Logo subtitle="Teacher" accent="secondary" size="sidebar" />
        </Link>
